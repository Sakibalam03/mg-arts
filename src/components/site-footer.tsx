...
export default async function SiteFooter() {
  ...
  return (
    <footer className="relative z-30 mt-auto overflow-hidden border-t border-gray-new-90 bg-white dark:border-gray-new-20 dark:bg-black-pure">
      <Container className="flex justify-between gap-x-10 py-12 sm:py-5" size={1920}>
        ...
        <div className="flex w-fit gap-x-[88px] xl:gap-x-6 max-sm:hidden">
