...
const Pattern = ({ src, isRight, className }: PatternProps) => (
  <Image
    className={cn(
...
const TopbarClient = ({ text, link }: TopbarClientProps) => {
  ...
  return (
    <Link
      className={cn(
        'group relative z-50 h-9 w-full overflow-hidden px-4 py-2.5',
